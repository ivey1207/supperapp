...
public class AdminAuthController {
    ...
    @Operation(summary = "Execute login operation")
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody Map<String, String> body) {
        ...
        Account account = accountRepository.findFirstByEmailAndArchivedFalse(email)
                .orElse(null);
    ...
    public ResponseEntity<?> me(@RequestHeader("Authorization") String authHeader) {
        ...
        try {
            ...
            Account account = accountRepository.findFirstByEmailAndArchivedFalse(accountId).orElse(null);
            if (account == null) {
