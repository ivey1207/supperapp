        ...
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.content}>
                <Animated.View style={[styles.topSection, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
                    ...
                    <Text style={styles.brandName}>SuperApp <Text style={{ color: '#3B82F6' }}>Uzbekistan</Text></Text>
                    <Text style={styles.tagline}>Все услуги для вашего авто в одном приложении</Text>
                </Animated.View>
