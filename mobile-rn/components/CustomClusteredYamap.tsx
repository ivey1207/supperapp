...
import CallbacksManager from 'react-native-yamap/src/utils/CallbacksManager';
import {
  Animation,
  Point,
  DrivingInfo,
  ...
  YandexLogoPosition,
  YandexLogoPadding
} from 'react-native-yamap/src/interfaces';
import { processColorProps } from 'react-native-yamap/src/utils';
...
export class ClusteredYamap extends React.Component<ClusteredYaMapProps> {
  ...
  public findMasstransitRoutes(points: Point[], callback: (event: RoutesFoundEvent<MasstransitInfo>) => void) {
    this._findRoutes(points, ClusteredYamap.ALL_MASSTRANSIT_VEHICLES, callback);
  }
