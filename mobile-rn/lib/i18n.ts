...
const resources = {
    uz: {
        translation: {
            ...
            goOnlinePrompt: 'Yangi buyurtmalarni ko\'rish uchun online bo\'ling',
            noOrdersNearby: 'Yaqin atrofda buyurtmalar yo\'q',
            newRequestsPrompt: 'Yangi so\'rovlar shu yerda paydo bo\'ladi',
            auth: {
    ...
    ru: {
        translation: {
            ...
            goOnlinePrompt: 'Выйдите в онлайн, чтобы видеть заказы',
            noOrdersNearby: 'Рядом нет заказов',
            newRequestsPrompt: 'Новые запросы появятся здесь',
            auth: {
    ...
    en: {
        translation: {
            ...
            goOnlinePrompt: 'Go online to see more orders',
            noOrdersNearby: 'No orders nearby',
            newRequestsPrompt: 'New requests will appear here',
            auth: {
    ...
    tr: {
        translation: {
            ...
            startWash: 'Başla',
            complete: 'Tamamla',
            openNavigator: 'NAVİGATÖRÜ AÇ',
            goOnlinePrompt: 'Daha fazla sipariş görmek için çevrimiçi olun',
            noOrdersNearby: 'Yakında sipariş yok',
            newRequestsPrompt: 'Yeni talepler burada görünecek',
            auth: {
